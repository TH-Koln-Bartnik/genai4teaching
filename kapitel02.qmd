...
**Was für LLMs gibt es aktuell?** Die großen Anbieter mit den jeweils stärksten Modellen (s. \@fig-leaderboard) sind OpenAI (Chat GPT-5), Google (Gemini 2.5) und Anthropic (Claude Opus 4.1 / Sonnet 4). Je nach Anwendung werden günstigere Modelle angeboten, die weniger Rechenaufwand benötigen, meist mit dem Zusatz „Mini“. Starke Reasoning Modelle (die komplexe Fragestellungen bearbeiten können) von OpenAI sind GPT 5 oder Gemini 2.5 Flash (Stand 08/2025). Kostenfrei nutzbare Open Source Alternativen sind z.B. Mistral (eines der wenigen europäischen Modelle) und Llama4 (von Meta/Facebook) sowie die chinesische Konkurrenz DeepSeek V3.1 @mollick2025; sowie @Vellum.ai.
...
![Je nach Ziel ein anderer Platz in der Bestenliste: „Schlauste“ und günstigste Modelle. Quelle: Vellum.ai, Stand 08/2025](images/script02-04.svg){#fig-leaderboard}
