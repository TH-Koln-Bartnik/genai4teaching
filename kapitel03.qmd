...
Ein Beispiel ist die **Vorlesung**. Es ist gut belegt, dass diese Form des passiven Konsums eine sehr schwache Form der Wissensvermittlung ist. **Man lernt nicht nichts, aber anders würde man mehr lernen.** Empirisch und theoretisch ist sehr gut belegt, dass Studierende Wissen besser behalten, wenn sie dieselbe Zeit für aktives Üben, Frage-Antwort Interaktionen oder Diskussion in Kleingruppen verwenden [@freeman2014a, @hake1998].

Praktisch wird oft mit dem positiven Effekt der reinen Anwesenheit argumentiert (besser als wenn die Studierenden zu Hause Netflix schauen; wer zur Vorleseung kommt hat bessere Noten), aber **diese spezielle Form der Präsenzlehre hat durch mangelnde Interaktion klare Nachteile.** Der Harvard Physiker @kestin2025 fasst drei zentrale Probleme von Vorlesungen zusammen: Mangelnde Anpassung, mangelndes individuelles Feedback und mangelnde Aktivierung der Lernenden. Genauer [@kestin2025, S.2-3]: "1. They move too quickly for some students and too slowly for others because the teacher controls the pace of instruction; 2. Students do not receive personalized feedback to their questions as they arise; and 3. They fail to maintain consistent student engagement."
...
![Illustration Zeitlich verteiltes Lernen - spacing](images/script03-lerntechniken-spacing.png){#fig-spacing fig-align="center"}

*Quelle: Erstellt mit Gemini3, basierend auf @roediger2012.*
...
![Illustration Inhaltlich gemischtes Lernen - spacing](images/script03-lerntechniken-interleaving.png){#fig-interleaving fig-align="center"}
...
![Illustration Testgestütztes Lernen - test-enhanced learning](images/script03-lerntechniken-testing-effect.png.png){#fig-testing-effect fig-align="center"}
