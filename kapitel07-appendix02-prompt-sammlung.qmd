...
## Vorbemerkung zur Struktur der Sammlung {.unnumbered}

Die hier vorgestellten didaktischen Prompts wurden aus verschiedenen internationalen Quellen zusammengetragen, übersetzt und in eine **standardisierte Form** (RTF oder CREATE-Schema, s.o.) überführt.
In der Navigationsleiste rechts können Sie zu den Prompts navigieren, die Sie interessieren.
Sie können die Prompts in der Online-Version **'ausklappen'** lassen und über einen Knopf rechts oben im Codeblock leicht kopieren.
Neben **Beispielen für die Prompts** sind jeweils auch detaillierte **Aufgabenstellungen** aufgeführt, die zeigen, wie wir die Prompts in eine Lehreinheit integrieren können.
**Testen Sie die Prompts am Besten gleich** im Sprachmodell Ihrer Wahl, oder lassen Sie den Prompt dort auf eine spezifische Lehreinheit hin anpassen.
Sie wollen vergleichen, wie die **Prompts mit verschiedenen Modellen funktionieren?** Nutzen Sie dafür die LM-Arena: <https://lmarena.ai/de?mode=side-by-side>.
Viel Spaß dabei!

## Hiwi: Schnelle Hilfe zur Lehrgestaltung

### Hiwi: Kursinhalte aktualisieren {#sec-prompt-update-kursinhalte}
...
### Hiwi: Aktivierungs-Coach für die Präsenzlehre {#sec-prompt-aktivierungs-coach}
...
### Hiwi: Strukturierter Prompt Designer {#sec-prompt-strukturierer}
...
**Quelle:** Selbst erstellt, für die Schemata (RTF, CREATE) basierend auf dem Prompt Guide des Project Management Institute (@pmi2024).
Eine Online-Version (GPT) finden Sie hier: https://chatgpt.com/g/g-695a8a7c9c888191a683135100f623d0-prompt-strukturierer-rtf-oder-create-format
...
### Hiwi: Potato-Prompt - Kurzbefehl für das kritische Hinterfragen eigener Argumente {#sec-prompt-potato}

**Funktion:** Denkhilfe zum kritischen Hinterfragen eigener Argumente.
Setzen Sie vor ein Argument den Kurzbefehl "potato" \[Argument\], um es von der KI kritisch beleuchten zu lassen.
Der „Potato“-Trigger soll insofern die KI in einen konsequent kritischen Prüfmodus versetzen.
Ziel ist es, aus Ihrer Eingabe drei mögliche Scheitergründe, zwei starke Gegenargumente und einen übersehenen blinden Fleck zu erhalten.
Überarbeiten Sie anschließend Ihre These so, dass die identifizierten Schwachstellen adressiert werden (z. B. Annahmen explizit machen, Randbedingungen ergänzen, Risiken absichern).
Dieser Kurzbefehl kann auch im System-Prompt angelegt werden (dafür: kürzen lassen).
Alternativ: Punktuell prompten, oder als "Projekt" (in ChatGPT) fest hinterlegen.

**Didaktische Elemente:** Scaffolding; Klärungsfragen.

**Quelle:** Angepasst nach diversen Quellen - der Ansatz ist recht populär - hier exemplarisch ein Blog-Post von Amanda Caswell [@caswell2026].

::: {.callout-note collapse="true" title="Potato Prompt - Kurzbefehl für kritisches Hinterfragen"}
``` markdown
[Role/Rolle]
...
8) Keine Abschlussfrage ohne explizite Bitte um Next Steps?
```
:::

### Hiwi: System-Prompt für typische Anforderungen erstellen {#sec-prompt-systemprompt}

**Funktion**: Erstellt allgemeine Instruktionen, die das Sprachmodell an die User-Bedürfnisse anpasst.
Es entsteht ein *angepasster* akademischer Hiwi für den eigenen Lehr- und Forschungsbereich.
Dieser System-Prompt kann im Sprachmodell hinterlegt werden ("Personalisierung" bei ChatGPT), oder als Textdatei punktuell beigefügt werden.
...
**Quelle**: Selbst erstellt; strukturiert nach dokumentierten Best Practices für System Prompts von OpenAI, Anthropic und Google [@kotha2025; @google2025; @anthropic2025c].
(acht Prinzipien: Struktur, Spezifität, Motivation, positive Formulierung, Beispiele, Unsicherheit, Reasoning, Iteration).

::: {.callout-note collapse="true" title="Hiwi: Allgemeine Anweisungen im System-Prompt"}
``` markdown
[Character]
...
### Hiwi: Quiz-Ersteller {#sec-prompt-quiz-maker}
...
::: {.callout-note collapse="true" title="Hiwi: Didaktische Quiz Ersteller"}
``` markdown
...
- Halte deine eigenen Gesprächsbeiträge in den Dialogphasen bewusst kurz
```
:::

### Hiwi: Protokolle für Treffen erstellen {#sec-prompt-protokoll}

**Funktion:** Meeting-Notizen verdichten; Action Items extrahieren; Verantwortlichkeiten zuordnen.
Grundlage kann hier ein Transkript aus MS-Teams oder Zoom sein, das in ein strukturiertes Format überführt wird.
...
::: {.callout-note collapse="true" title="Hiwi: Meeting protokollieren"}
``` markdown
[Role / Rolle]
...
### Hiwi: Flash-Debatten Organisierer {#sec-prompt-flash-debate}

**Funktion:** Debatten-Statements generieren; anschließend Rollenspiel-Setup aus den Statements ableiten.
Hier als Beispiel, das für andere Lehrinhalte angepasst werden kann.
...
### Hiwi: KI-gestützte Übungsaufgaben erstellen {#sec-prompt-übungen}
...
### Tutor: Allgemeiner Tutor {#sec-general-tutor}
...
### Tutor: Reflexionshilfe {#sec-prompt-reflexionshilfe}
...
### Tutor-Aufgabe: Sokratischer Dialog mit GenAI {#sec-prompt-sokratischer-dialog}

**Funktion**: Dieses Lehrsetting kombiniert geführte Dialoge mit Künstlicher Intelligenz (KI) mit Phasen, in denen bewusst auf Technologie verzichtet wird ("unplugged").
Das Ziel ist die Förderung kritischer Denkfähigkeiten durch die Methode des *Sokratischen Dialogs*.

Die Studierenden stellen der KI definitorische und prüfende Fragen, identifizieren implizite Annahmen in den generierten Antworten und überarbeiten diese eigenständig.
Das Endprodukt ist eine überarbeitete Fassung inklusive Begründungen und einer Dokumentation des kognitiven Prozesses.
...
### Tutor-Aufgabe: Einen Argumentationsplan theoriegestützt entwickeln {#sec-prompt-argumentationsplan}

**Funktion:** Studierende entwickeln mit Hilfe des KI-Tutors einen Argumentationsplan, basierend auf der Stasis-Theorie (Tatbestand, Definition, Qualität, Verfahren).
Die KI stellt nacheinander die vier Fragen, sammelt strukturierte Antworten, skizziert tragfähige Argumentationslinien und begründet die Auswahl.
Die Studierenden überführen dies in einen Argumentationsplan mit Evidenz-Roadmap.
...
### Tutor-Aufgabe: Korrigiere einen schlechten Aufsatz {#sec-prompt-aufsatz-korrigieren}
...
### Copilot: Fallstudie gemeinsam erstellen {#sec-prompt-fallstudie-erstellen}
...
**Quelle:** Angepasst & übersetzt basierend auf @MoreUsefulThingsStudentExercises, Co-create a case study with Copilot.
...
### Copilot: Dem Tod ins Auge sehen - Pre-Mortem für Projekte {#sec-prompt-project-premortem}
...
**Quelle:** Angepasst & übersetzt basierend auf @MoreUsefulThingsStudentExercises, Project pre-mortem.
Online: https://www.moreusefulthings.com/student-exercises.
...
### Copilot: Ungeliebte Positionen vertreten lassen (Devil’s advocate) {#sec-prompt-devils-advocate}
...
**Quelle:** Angepasst & übersetzt basierend auf @MoreUsefulThingsStudentExercises.
Devil's Advocate.
Online: https://www.moreusefulthings.com/student-exercises.
...
### Copilot: Team-Charter erstellen {#sec-prompt-team-charter}
...
**Quelle:** Angepasst & übersetzt basierend auf @MoreUsefulThingsStudentExercises, Create a Team Charter.
More Useful Things.
Online: https://www.moreusefulthings.com/student-exercises.
...
### Copilot: Team-Reflexion / After Action Review {#sec-prompt-after-action-review}
...
**Quelle:** Angepasst & übersetzt basierend auf @MoreUsefulThingsStudentExercises, Team Reflection.
More Useful Things.
Online: https://www.moreusefulthings.com/student-exercises.
...
### Copilot-Aufgabe: DuPont-Analyse eines Geschäftsberichtes {#sec-prompt-dupont-analyse}

**Funktion:** Eine komplexe Methodik mit Hilfe der KI an einem realen Beispiel ausprobieren.

Die Studierenden zerlegen den ROE in Marge, Kapitalumschlag und Leverage, berechnen Kennzahlen für Coca-Cola und vergleichen ihre Resultate mit einer KI-gestützten Analyse.
Ziel ist die fachliche Plausibilisierung von Rechenwegen, die Abweichungsanalyse und die Aufbereitung der Ergebnisse als Executive-Memo.
...
### Copilot-Aufgabe: Fehlinformation erstellen und analysieren {#sec-prompt-desinformation}
...
### Copilot-Aufgabe: Iteratives, systematisches Testen von Prompts {#sec-prompt-testen}

**Funktion:** Die Studierenden entwickeln einen Prompt für eine konkrete Arbeitsaufgabe und testen ihn iterativ mit der KI.
Sie protokollieren Fehlerbilder (Halluzinationen, Formatbrüche, fehlende Belege), verschärfen Constraints und ergänzen Output-Checks.
Ergebnis ist ein dokumentierter Prompt-Evolutionspfad mit Qualitätskriterien.
...
### Copilot-Aufgaben: 'AI-Sandwich ' - GenAI in einen Kurs integrieren {#sec-prompt-ai-sandwich}
...
### Copilot-Aufgabe: KI, die Zukunft und Du {#sec-prompt-ai-zukunft}

Die Lehrperson verankert das Sandwich-Prinzip in der Aufgabenstellung: Zuerst werden Lernziele und Kriterien ohne GenAI erarbeitet, dann unterstützt die GenAI bei Ideengenerierung, Struktur und Rohentwürfen, und abschließend folgt die menschliche Überarbeitung mit Quellenprüfung und Reflexion.

Die Studierenden analysieren die Auswirkungen von KI auf Berufsbilder, recherchieren Quellen und entwickeln einen individuellen Aktionsplan.
Die KI unterstützt bei der Perspektivenbildung, der Strukturierung der Argumente und bei der Vorbereitung von Diskussionen; die Bewertung erfordert überprüfbare Quellenarbeit und reflektierte Begründung.
...
### Simulator: Simulation eines Forschungsinterviews {#sec-prompt-interview-simulator}
...
### Simulator: Verhandlungssimulation {#sec-prompt-verhandlungssimulator}
...
**Didaktische Elemente:** Scaffolding (durch KI-Mentor); Formatives Feedback (Debriefing); Adaptives Lernen (Szenario-Wahl).
Situiertes Lernen.

**Quelle:** Angepasst & übersetzt basierend auf @mollickMollickMoreUsefulThingsStudentExercises.
...
### Simulator: Goal Play - Lernsimulation zur Anwendung einer Analysetechnik {#sec-prompt-methoden-simulator}
...
**Hinweis - hier exemplarisch angewendet**: Hier wird das Prinzip einer solchen Simulation am Beispiel der Methode „self-distancing“ gezeigt.
Solch eine Art von Simulation kann aber auch für andere Methoden oder Techniken durchgeführt werden.
Für einen ersten Wurf nehmen Sie diesen Prompt als Vorlage und lassen ihn dann durch ein starkes Sprachmodell und evtl.
mit zusätzlicher Eingabe einer Methodenbeschreibung anpassen.
...
**Quelle:** Leicht angepasst & übersetzt basierend auf @mollickMollickMoreUsefulThingsStudentExercises.
Goal Play: Help a character get perspective.
Online: https://www.moreusefulthings.com/student-exercises.
...
### Simulator: Goal Play - Zielsetzung üben {#sec-prompt-goal-setting}
...
**Quelle:** Leicht angepasst & übersetzt basierend auf @mollickMollickMoreUsefulThingsStudentExercises Mollick, E.
& Mollick, L.
(2024).
Goal Play: Help a character achieve goals.
Online: https://www.moreusefulthings.com/student-exercises.
...
### Interview mit einer fiktionalen Person {#sec-prompt-interview-fiktionale-person}
...
### Simulator-Aufgabe: Schwierige Interaktionen üben (Beispiel: Telefongespräch von Pflegenden mit Patienten) {#sec-prompt-simulation-interaktion}
...
### Simulator-Aufgabe: Simulation in der Veterinärmedizin {#sec-prompt-simulation-veterinärmedizin}
...
::: {.callout-note collapse="true" title="Simulator: Szenarios in der Veterinärmedizin"}
```         
[Character]
