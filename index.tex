...
individuelles Feedback zu Studienarbeiten (s. etwa Hattie, 2023, Kap.13;
\textbf{brown2014a?}). Wer lehrt, fühlt sich aus Zeit- und Stoffdruck
oft gezwungen, Abstriche von idealen Lehrsetups zu machen
(\textbf{henderson2007a?}; \textbf{schmidt2005a?}). Gerade Lehrmethoden,
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Schnelles Brainstorming mit der KI}, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
oder mit den Studierenden Rollenspiele durchführen (E. Mollick \&
Mollick, 2023; \textbf{meincke2024a?}). Der Berg ist noch da, aber mit
...
Präsentation erstellt und testet (Anthropic, 2025).
...
Studierende besonders gut funktionieren (s. (\textbf{kapitel03?})) und
die zweite zur Frage, welche Best-Practices es gibt, Aufgabenstellungen
mit der intensiven Nutzung von GenAI zu verbinden (s.
(\textbf{kapitel06?})).

Zu integrierten Aufgaben mit GenAI liefert uns das Sprachmodell nach
etwa 5 Minuten 15 sehr schicke Folien (NotebookLM, basierend auf 13
Quellen-PDFs).
...
verarbeiten'' (\textbf{korinek2024b?}, Übersetzung RB mit DeepL). Die
professionelle Nutzung ist hier teils noch weiter: So demonstrierte etwa
Google 2025 ein mehrstufiges Modell für die Pharma-Forschung
(„\textbf{AI co-scientist}''), das den Forschenden zeitintensive
Zwischenschritte abnimmt (\textbf{gottweis2025a?}). Auch im Peer-Review
werden zunehmend Sprachmodelle eingesetzt -- mit allen Vor- und
Nachteilen, die das mit sich bringt (Naddaf, 2025). Wie wir in den
...
Prüfung (etwa (\textbf{brown2014a?}), S.90-94, ``generative learning'',
oder die Studien von Willemain zur Modellierung von Problemen durch
Experten (Willemain, 1994; \textbf{willemain1995b?})). Ein neuer
Ansatzpunkt zur Verbesserung der Ergebnisse wird hier genutzt
(Grootendorst, 2025) : Statt (nur) mehr Ressourcen in das Training immer
komplexerer Modelle zu investieren (train-time compute), werden die
Modelle jetzt dazu angehalten, länger ``nachzudenken'', bevor sie ein
Ergebnis anbieten (test-time compute). Hinter diesem ``besseren
Nachdenken'' stehen zwei Prinzipien (Grootendorst, 2025; Snell et al.,
2024): Die Sprachmodelle werden einerseits instruiert, schrittweise
vorzugehen (Input-Verbesserung der Vorschlagsverteilung) und
andererseits dazu angehalten, die eigenen Antworten zu prüfen
(Output-Verbesserung, Verifizierer). Die Sprachmodelle führen insofern
jetzt teils selbstständig Prüfschritte durch, die man früher durch
komplexe Prompts induziert hätte. Ende 2025 sehen wir in der Konsequenz,
dass die Sprachbots immer selbstständiger werden, man spricht vom
``Agentic Turn''(E. R. Mollick, 2025a; Steinberger, 2025; Willison,
...
längere Aufgaben auf hohem Niveau erledigen können (\textbf{kwa2025a?}).
...
Cent (InvertedStone, 2025; E. R. Mollick, 2025b). Das Modell
...
(\textbf{korinek2024b?}). Das gilt zunehmend für die stärksten
...
Auswirkungen auf den Arbeitsprozess in der Wissensarbeit (s. etwa
(\textbf{schwarcz2025a?}) für juristische Recherchen,
(\textbf{korinek2024b?}) für Ökonomie und (\textbf{liang2025a?}) für
PR-Tätigkeiten).
...
einen breiten Strauß an Zielen (s. Abbildung~\ref{fig-llm-nutzung}).
Eine Auswertung der KI-Forscher des KI-Unternehmens \emph{Anthropic} von
1 Millionen anonymisierten Chats zwischen Usern mit Universitätskonto
und dem KI Bot zeigt typische Muster der Nutzung (\textbf{handa2025c?}):
Studierende setzen das Sprachmodell \textbf{vor allem für anspruchsvolle
Tätigkeiten} ein, wie das \textbf{Erstellen neuer Inhalte und das
Analysieren komplexer Themen}, was höheren Ebenen der Bloomschen
Taxonomie entspricht (s. Abbildung~\ref{fig-llm-nutzung-bloom}). Daraus
...
Programmierer programmieren schneller (\textbf{peng2023a?}), Consultants
sind produktiver bei komplexen Beratungsprojekten
(\textbf{dellacqua2023a?}) und Sprachmodelle wie ChatGPT können eine
Vielzahl kleiner Aufgaben beschleunigen (\textbf{handa2025c?}) und
werden insofern gerade zur Texterstellung schon millionenfach als
Hilfsmittel im Beruf genutzt: Von Kundenbewertungen über
Pressemitteilungen und Stellenanzeigen (\textbf{liang2025a?}).
...
(Claude) durch Studierende nach der Bloom'schen Taxonomie. Quelle:
(\textbf{handa2025c?})}
...
beide Aspekte ab: Sie sind einfach zu nutzen (Kestin et al., 2025;
\textbf{lee2025a?}; \textbf{monib2025a?}; \textbf{naddaf2025c?}) und
erzeugen einen deutlichen Mehrwert, wie Studierende und Lehrende in
einer Vielzahl von Umfragen der letzten zwei Jahren berichten
(\textbf{heidt2025a?}; \textbf{morgan2024a?}; \textbf{ou2024a?}).
Lehrende ziehen nach: Meta-Untersuchungen zeigen ein extremes Wachstum
an Publikationen zur Nutzung von LLM im Hochschulalltag
(\textbf{ma2025a?}; \textbf{ogunleye2024a?}).
...
\textbf{Studierende nutzen GenAI bereits umfangreich für anspruchsvolle
Aufgaben.} Die Analyse von 1 Millionen anonymisierten Studierenden-Chats
durch Anthropic (\textbf{handa2025c?}) zeigt einerseits, dass
\textbf{Studierende das LLM vor allem für kognitiv anspruchsvollere
Aufgaben einsetzen}, vor allem in den Kategorien „Creating'' und
„Analyzing'' (s. \textbf{?@fig-bloom-taxonomie}).
...
gleich das gesamte Bündel fertig verschnürt bereitgestellt.
Schlimmstenfalls droht das, was ein Artikel von Walsh
(\textbf{walsh2025a?}) prägnant betitelt: ``Everybody is cheating their
way through college''. Wenn klassische Projektaufgaben quasi auf
Knopfdruck erstellt werden können, droht diese Form von Leistung sinnlos
zu werden. Mit etwas Lust an Dramatik können wir uns Endzeit-Szenarien
vorstellen, in denen Lehrende klagend durch die Trümmer ihrer schönen
Portfolio-Prüfungen stolpern: Die Homework-Apocalypse
(\textbf{mollick2023d?}).
...
Test-Spezifikation oder eines Protokolls) (\textbf{lee2025a?}).
...
Prüfungen} ein (Abschnitt 5). Im Appendix finden Sie eine breite
Sammlung von didaktischen Prompts und auf GenAI ausgerichteten
Aufgabenstellungen von führenden Hochschulen.
...
Lehrbuch-Standardwerk von (\textbf{jurafsky2025a?}) nutzen, das online
frei verfügbar ist.
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Lernspiel: Welche Grundbegriffe kennen Sie schon?}, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
dieser Kette (\textbf{jurafsky2025a?}), Kap.7, S.2). Ein großes
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tipp: Mini-Interaktionen einfach als HTML erstellen}, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
Wörter, Wortteile oder Satzzeichen (s. etwa \textbf{jurafsky2025a?}).
Jedes dieser Tokens wird in einen \textbf{Vektor} umgewandelt -- eine
Zahlenreihe, die das Wort mathematisch beschreibt. Dieser Vorgang nennt
sich \textbf{Embedding}. Dabei wird darauf geachtet, dass ähnliche
...
umgewandelt}, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
Anwendungsfelder?}, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
Antworten oder Denkprozessen?}, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
(\textbf{lindsey2025a?}), was uns erstmals etwas genauer verstehen
lässt, wie Sprachmodelle mit verschiedenen Sprachen umgehen, wie sie den
...
bekannten Namen gibt das Modell an, die Antwort nicht zu kennen
(\textbf{lindsey2025a?}).
...
DeepSeek V3.1 (E. R. Mollick, 2025a; sowie Vellum, 2024).
...
(\textbf{dellacqua2023a?}). Mollick und Kollegen prägen hierfür den
Begriff einer „\textbf{Jagged Technological Frontier}`` (zerklüftete
Technik-Grenze) (\textbf{dellacqua2023a?}). Zwei Aufgaben von ähnlicher
...
unbrauchbare oder falsche Resultate) (\textbf{dellacqua2023a?}).
...
häufig korrekt als die ohne KI (\textbf{dellacqua2023a?}). Dieses
...
(\textbf{dellacqua2023a?}).

Für folgende Anwendungsfälle sind LLMs mittlerweile gut nutzbar
(\textbf{handa2025c?}; \textbf{korinek2024b?}; \textbf{schwarcz2025a?}):
...
verdoppelt sich seit 2019 etwa alle 7 Monate (\textbf{kwa2025a?}). Auch
...
Paper Wizard (\textbf{lovely2025a?}; \textbf{naddaf2025c?}).
...
(\textbf{jones2025a?}). In einem randomisierten
...
Law, (\textbf{mollick2025d?})) beschreiben: KI-Modelle werden einerseits
...
(\textbf{gottweis2025a?}; \textbf{openai2024a?};
\textbf{schwarcz2025a?}).
...
personalisierter und adaptiver Lernangebote (\textbf{mollick2024f?}).
...
auszunutzen (\textbf{dellacqua2023a?}): Der \textbf{Centaur-Ansatz}
teilt die Aufgabe, indem der Mensch der KI die Teilprobleme überlässt,
die innerhalb der Frontier liegen, und sich selbst auf den Rest
...
ganzen Teams zu bringen (\textbf{dellacqua2025b?}).
...
\item
  ...
  funktionieren (\textbf{schwarze2025a?}). Hier muss man einmalig das
  System aufsetzen (Witsy) und für den höheren Komfort teils eine eine
  Lizenz kaufen (TypingMind, ca. 40 \$ für Hochschulangehörige), dafür
  kann man dann einfacher Modelle wechseln und über einen sogenannten
  API Key nur die tatsächliche Nutzung abrechnen (was sich bei einfacher
  Nutzung auf ein paar Cent beläuft, siehe die oben gezeigte Übersicht
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hinweis}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
zuverlässig (Meincke et al., 2025b, 2025a; \textbf{meincke2025c?}).
Hilft es, \textbf{höflich} zu sein (nein), zu \textbf{drohen} (nein),
...
behalten (\textbf{roediger2012b?}). Konkrete und sehr detaillierte
...
Umweltbelastung konfrontiert (\textbf{spencer2025a?}). Auch bei der
...
2008 (\textbf{elsworth2025a?}; \textbf{mollick2025d?}). Die gute
Nachricht ist, dass die Modelle effizienter werden und der
...
weiter zu senken. Gegenläufig und problematisch ist die stark steigende
Nutzung, die z.B. zur Ausweitung gerade umweltbelastender Energieformen
wie Gasturbinen führt (Wittenberg, 2025).
...
Untersuchung des MIT Technology Survey (\textbf{odonnell2025a?})
...
\textbf{spencer2024a?}). Mit Blick auf die Zukunft ist der rasant
...
für Emissionswachstum und Klimawandel (\textbf{spencer2024a?}). Einige
...
auf die großen Hebel der Emissionsvermeidung ablenken zu lassen
(Ritchie, 2024b; \textbf{masley2025a?}). Während die Einmalaufwände für
das Training der Modelle erheblich sind, hat das schnelle Wachsen der
Nutzerzahlen sie mittlerweile in den Schatten gestellt. Die
Energieaufwände für Anfragen (Inferenz) bedingen nunmehr einen größeren
Energieverbrauch als das Training der Modelle (\textbf{odonnell2025a?};
\textbf{spencer2025a?}).
...
Modelle (\textbf{odonnell2025a?}; \textbf{you2025a?}).
...
Unterschied (\textbf{odonnell2025a?}).
...
calculations as a model from 2008'' (\textbf{spencer2024a?}).
...
hohen Investitionen absehbar ist (\textbf{odonnell2025a?}).
...
(\textbf{odonnell2025a?}). Dem gegenüber stehen \textbf{gegenläufige
...
emissionsfreier Energie betrieben werden (\textbf{spencer2025a?}).
...
12\% des US-Strombedarfs ausmachen (\textbf{odonnell2025a?}).
...
Architektur} können diese Entwicklung abbremsen
(\textbf{spencer2025a?}).
...
vermieden wird (\textbf{odonnell2025a?}).
...
werden (Greene-Dewasmes \& Tladi, 2025; \textbf{spencer2025a?}).
...
durch die Modellanbieter} (\textbf{odonnell2025a?}).
...
(\textbf{mollick2023i?}) argumentieren, dass KI als ``Kraftverstärker''
für Lehrkräfte dienen kann, indem sie die Implementierung
evidenzbasierter Lehransätze erleichtert, die sonst aufgrund von Zeit-
und Arbeitsaufwand oft schwer umzusetzen sind. Aber wie wirkt das? Was
begründet die erhoffte Wirkung?
...
verschiedene Nutzungskontexte zu vergleichen (\textbf{chi2018a?}).
...
erklären (\textbf{korinek2024b?}) und zum Selbststudium komplette
...
(\textbf{chen2024a?}). (\textbf{wang2024a?}) sprechen von KI als
„Confusion Helper``. Um Halluzinationen zu vermeiden, wird das Modell
häufig per Retrieval-Augmentation an externe Wissensbasen gekoppelt
(also z.B. durch Beigabe von Skripten oder Fachartikeln als PDF. Siehe
auch das Harvard-Tutor-Bot Beispiel in Abschnitt 4.3, wo Musterlösungen
beigegeben werden.).
...
Tutorendialogen (\textbf{scarlatos2025a?}). Sprachmodelle können
Lehrenden dabei helfen, komplette „worked examples`` mitsamt
Zwischenschritten zu generieren (\textbf{hassany2024a?}).
...
theoriegeleitetes Verständnis Gründen für Fehler zugrunde liegt.
(\textbf{zhang2025b?}) demonstrieren dies am Beispiel eines selbst
entwickelten multimodalen \textbf{Mathematik-Tutor-Bots} (MathCCS,
Mathematical Classification and Constructive Suggestions).
...
Annahme, dass Interaktionen besonders effektiv zum Lernen beitragen
(\textbf{chi2018a?}; \textbf{hayashi2025a?}). Wie auch in der
persönlichen Interaktion scheint hierbei wichtig zu sein, welche
„Persönlichkeit`` der KI-Bot hat, dem Studierende etwas beibringen
sollen (\textbf{lyu2025a?}) und mehr Anstrengung in der Interaktion
(etwa durch ausführlicheres Formulieren beim Erklären) führt zu mehr
Lernerfolg (\textbf{love2025a?}).

Sprachmodelle können genutzt werden, um komplexe mathematische
Anwendungsprobleme mit einem simulierten User „durchzuspielen``, so dass
logische Fehler im Lösungsprozess sichtbar werden, wie der Prototyp
„MathChat`` von (\textbf{wu2024e?}) zeigt.
...
(\textbf{meincke2024a?}; \textbf{shaer2024a?}). Auch hier ist jedoch die
...
Denkprozesse nicht eingeübt werden (\textbf{lee2025a?}).
...
effektiv heraushebt (siehe (\textbf{morth2021a?}) für eine gute
...
(\textbf{morth2021a?}); (\textbf{roediger2012b?})). Diese Wirkung gibt
es allerdings nicht umsonst: Den positiven Effekten der Techniken steht
oft ein deutlich höherer Vorbereitungsaufwand gegenüber. Wie im
Folgenden kurz skizziert wird, lassen sich KI-Tools nutzen, um den
Aufwand dieser drei Mechanismen zu verringern, was die Lernwirkung im
Vergleich zu traditionellen Ansätzen deutlich erhöhen kann.
...
einzigen, intensiven Sitzung (\textbf{brown2014a?};
\textbf{murre2015a?}; \textbf{roediger2012b?}). \textbf{Abstände}
zwischen Lerneinheiten und die wiederholte Aktivierung von
Wissensstrukturen stärken die Verbindung zwischen Hinweisreizen und
...
Themenblöcken, die linear im Semesterverlauf abgehandelt werden
(\textbf{morth2021a?}). Das liegt daran, dass das gemischte Üben die
...
anstrengender, es bringt aber deutlich mehr (\textbf{brown2014a?}). Ein
...
Lernerfolg durch mehrere Mechanismen (\textbf{roediger2006b?}). Erstens
fördert solches Testen das transfergerechte Verarbeiten, da die mentalen
Prozesse beim Testen und beim späteren Abrufen ähnlich sind, was die
Erinnerungsfähigkeit verbessert. Zweitens stärkt die Wiederholung durch
Tests einerseits den erinnerten Inhalt und fügt andererseits neue
‚Haken` hinzu, mit denen wir den Inhalt aus dem Gedächtnis ziehen: die
Beziehungen zwischen Hinweisreizen (\emph{cues}) und dem Inhalt im
Gedächtnis, indem zusätzliche Abrufwege zu gespeicherten Wissensmustern
geschaffen werden, was den Abruf verbessert. Praktisch kann man diesen
tollen Effekt auch recht einfach durch regelmäßige kurze Fragerunden
nutzen: Wie die Lernforscher herausstellen: „frequent low-stakes quizzes
(last only 5 or 10 min) can produce a large boost in performance``
(\textbf{roediger2012b?}).
...
dem Postulat der ICAP-Theorie des kognitiven Engagements
(\textbf{chi2018a?}): Interaktion (I) ist effektiver als individuelle
Konstruktion, was wiederum effektiver ist als aktive (aber nicht
konstruktive) Beteiligung, was wiederum die passive Lernteilnahme
schlägt (I \textgreater{} C \textgreater{} A \textgreater{} P).
...
bei Materialerstellung & Wharton School (UPenn) &
(\textbf{mollick2024f?}) \\
...
School (UPenn) & (\textbf{mollick2024f?}) \\
...
Fachinhalte & University of Southern California (USC) &
(\textbf{bien2025a?}) \\
\textbf{KI als Tutor} & KI-Tutoren für Physikvorlesungen & Signifikante
Leistungssteigerung, höheres Engagement & Harvard University &
(\textbf{kestin2024b?}) \\
& KI-basierte Tutoren für Geschäftsverhandlungen & Verbesserte
Kommunikationsfähigkeiten & Wharton School (UPenn) &
(\textbf{mollick2024f?}) \\
...
Technology, Sydney \& Manchester & (\textbf{tutton2025b?}) \\
...
Zeitaufwand für Verwaltung stieg an (\textbf{schomburg2012a?}).
...
Nobelpreisträger Daron Acemoglu (Autor, 2015; \textbf{acemoglu2019a?}).
Eine nützliche Kategorisierung unterscheidet \textbf{drei Effekte} neuer
Technologien auf den Faktor Arbeit: Technologische Veränderungen können
menschliche Arbeit ersetzen (\textbf{Verdrängungseffekt} / displacement
effect), spezifische Arbeitskräfte produktiver machen
(\textbf{Produktivitätseffekt} / productivity effect / augmentation),
oder neue Aufgaben (und Jobs) schaffen (\textbf{Wiedereinsetzungseffekt}
/ reinstatement effect) (\textbf{acemoglu2019a?}).
...
Theorierahmen nach
(\textbf{acemoglu2019a?})}\label{tbl-acemoglu}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Effekt
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
letzten zwei Jahre geben hierzu deutliche Hinweise
(\textbf{morgan2024a?}; \textbf{naddaf2025c?}; \textbf{ogunleye2024a?};
\textbf{ou2024a?}; \textbf{tutton2025b?}).
...
und effektiver erfüllen können (\textbf{gottweis2025a?};
\textbf{meincke2024a?}; \textbf{mollick2024f?}; \textbf{mollick2023i?};
\textbf{schwarcz2025a?}).
...
KI-Technologien (\textbf{dihan2025a?}; \textbf{mollick2024d?};
\textbf{mollick2024f?}).
...
etwa die Einrichtung eines Physik-Tutor-Bots (\textbf{kestin2024b?})
oder einer Startup-Simulation, in der KI in verschiedenen Rollen beim
Aufsetzen und Verbessern von Geschäftsplänen hilft
(\textbf{mollick2024d?}). Beide Konzepte führen sichtlich zu einer
Verbesserung der Lehre, aber die gibt es auch hier nicht umsonst.
...
Konzepte in realen Kontexten veranschaulichen (\textbf{mollick2023i?}).
Dies fördert ein tieferes Verständnis und eine breitere Anwendbarkeit
der Inhalte. Ebenso kann KI den Verwaltungsaufwand für Kurse verringern,
indem sie dabei hilft, Übersichten, Dokumente und Präsentationen zu
erstellen. Idealerweise verschiebt sich dann die Energie der Lehrenden
auf Kernkompetenzen wie individuelle Erläuterung, Motivation und
...
oder Code-Generierung (Naddaf, 2025; \textbf{naddaf2025c?}). KI als
„Co-Scientist`` (\textbf{gottweis2025a?}) -- positiv gesehen
\textbf{werden die Hiwis immer schlauer}.
...
Kursvorbereitung. Quelle: Basierend auf Gimpel et al. (2023);
(\textbf{mollick2023i?});
(\textbf{mollick2022b?})}\label{tbl-prep-apps}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Kategorie
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
Texterstellung und Zusammenfassung (Brynjolfsson et al., 2025;
\textbf{handa2025c?}; \textbf{schwarcz2025a?}).

Für die \textbf{Recherche und Textgenerierung} lässt sich der Hiwi gut
nutzen (\textbf{mcknight2022a?}): Machen Sie die KI zu
Recherche-Assistenten, um Themen umfassend zu recherchieren und Texte
zur Überprüfung sowie Referenzen für nachfolgende Untersuchungen der
Studierenden zu kompilieren (z.B. mit Complexity.ai oder dem Consensus
GPT (Add-on zu ChatGPT) sowie neueren Lösungen wie Deep Research
(\textbf{schwarcz2025a?}) und spezialisierte Lösungen wie Elicit, die
auf akademische Datenbanken zurückgreifen (jedoch oft nur auf Abstracts,
keine Volltexte). Diese Materialien können als Grundlage für originale
und sorgfältig referenzierte Schreibarbeiten dienen. Nutzen Sie KI-Tools
für routinemäßige Texte, wie Blog-Inhalte, und bewerten Sie kritisch, wo
und warum KI-Texte, menschliche Texte oder Hybridtexte angebracht sind.
...
2023; \textbf{mollick2023i?}; \textbf{mollick2022b?}): KI kann die
...
vorzubereiten (\textbf{mollick2024d?}). Durch \textbf{Zusammenfassung
und Analyse von Rückmeldungen} der Studierenden können
Verständnisprobleme und Lernlücken identifiziert werden. KI kann
...
die User zeigen (\textbf{mollick2024d?}). KI kann Bezüge zwischen
...
(\textbf{mollick2023i?}; \textbf{mollick2024f?}).
...
\textbf{Qualität neuer Multiple-Choice Fragen zu bewerten}
(\textbf{lu2024b?}).
...
reicht (\textbf{heidt2025a?}).

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5000}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5000}}@{}}
\caption{Tabelle 4: Aktuelle Nutzungsbeispiele von KI zur
Lehrunterstützung. Quelle: Zusammengestellt nach
(\textbf{heidt2025a?})}\label{tbl-nature-examples}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Fachgebiete
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
wir sonst nicht könnten. (\textbf{mollick2024f?}) beschreiben mehrere
solcher Ansätze: Bei der \textbf{``Case Co-Creation''}
(\textbf{mollick2024f?}) arbeiten Studierende mit der KI zusammen, um
...
sein kann (\textbf{mollick2024f?}).

Wie können \textbf{LLMs als Programmierassistenten} bei Coden und
Datenanalyse helfen? (\textbf{bien2025a?}) beschreiben den Einsatz von
GitHub Copilot in einer \textbf{Einführung in die Datenanalyse für
...
(\textbf{bien2025a?}). Der Mehrwert ist, dass Studierende direkt mit
Daten interagieren und experimentieren können
(``translator-in-your-ear''), was das Verständnis fördert und die
Hemmschwelle senkt (\textbf{bien2025a?}). Herausforderungen liegen in
der Inkonsistenz der KI (gleicher Prompt kann unterschiedlichen Code
...
der Ergebnisse mitigiert werden muss (\textbf{bien2025a?}).

(\textbf{liang2024a?}) untersuchten in einer großangelegten Umfrage die
\textbf{Usability von KI-Programmierassistenten} wie GitHub Copilot. Sie
fanden heraus, dass Entwickler diese Tools vor allem nutzen, um
Tastenanschläge zu reduzieren, Aufgaben schneller zu erledigen und
Syntax abzurufen (\textbf{liang2024a?}). Erfolgreiche Anwendungen sind
die Generierung von repetitivem Code oder Code mit einfacher Logik sowie
Unterstützung beim Lernen neuer Sprachen/APIs (\textbf{liang2024a?}).
Als zentrale Herausforderungen wurden genannt, dass der generierte Code
oft funktionale oder nicht-funktionale Anforderungen nicht erfüllt, die
Steuerung des Tools schwierig ist und Nutzer oft nicht verstehen,
welcher Input zum Output führte (\textbf{liang2024a?}).
...
Überabhängigkeit (\textbf{mollick2024f?}). Die Notwendigkeit einer
kritischen Prüfung der KI-Ergebnisse (``Human in the Loop'') durch die
Nutzer ist zentral (\textbf{mollick2024f?}).
...
DeepL, Grammarly, oder ChatGPT (\textbf{ou2024a?}). (\textbf{ou2024a?})
...
wird weiter wichtig sein, die saubere Argumentation zu üben
(\textbf{friedrich2023a?}; \textbf{klein2023a?}).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Probieren Sie mal}, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
Baresel et al. (2024), basierend auf
(\textbf{rowland2023a?})}\label{tbl-llm-scale}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Grad der KI-Nutzung
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
2023; \textbf{mollick2023i?}). Der übergeordnete Gedanke ist, KI nicht
...
(\textbf{mollick2023i?}) sowie die verlinkten
...
erfolgen (\textbf{lee2025a?})? In diesem Fall darf man vermuten, dass
die negativen Effekte noch höher wären, wenn wir die Lehre nicht
anpassen.
...
Programmierer werden mit KI Copiloten deutlich schneller
(\textbf{peng2023a?}) und Lehrbücher haben zunehmend Namen wie „Learn
AI-assisted Python Programming`` (\textbf{porter2024a?}). Studierende
...
programmieren (\textbf{gieselmann2024a?}) oder mit Tools wie
Violentmonkey kleine Skripte für die individuelle Anzeige von
Lieblings-Websites erstellen (Eikenberg, 2025).
...
fortgeschrittene statistische Auswertungen heranführen kann
(\textbf{bien2025a?}). In einer Einführungsvorlesung für
...
auf das Lernen auswirkte (\textbf{puryear2022a?}). Studierende
...
(GitHub Copilot) (\textbf{denny2023a?}). Eine öffentliche Datenbank mit
...
dass Kernkompetenzen dennoch vermittelt werden
(\textbf{nizamudeen2024a?}).

Wofür nutzen professionelle Programmierer*innen die Copiloten? Eine
Studie untersucht dies mit einer Umfrage unter 410 Entwicklern
(\textbf{liang2024a?}). Die wichtigsten Gründe der Nutzung waren
...
und einfache Programmieraufgaben effizienter zu erledigen
(\textbf{bien2025a?}; \textbf{liang2024a?}; \textbf{nizamudeen2024a?};
\textbf{puryear2022a?}). Ein wesentliches Potenzial dieser Tools liegt
...
KI-Ausgaben (\textbf{denny2023a?}), sowie das Verständnis dafür, wie
Input den generierten Output beeinflusst (\textbf{liang2024a?}). Jedoch
...
müssen oder den KI-generierten Code ganz verwerfen
(\textbf{liang2024a?}). Dies unterstreicht, dass trotz erheblicher
Erleichterungen durch KI grundlegende Programmierkenntnisse weiterhin
notwendig sind, um Lösungen kritisch zu bewerten und effektiv anzupassen
(\textbf{puryear2022a?}).
...
(\textbf{mollick2024f?}) beschreiben eine Reihe allgemeiner
Tutorenkonzepte: Der \textbf{``Integration Agent''}
(\textbf{mollick2024f?}) fordert Studierende durch offene Fragen heraus,
Verbindungen zwischen verschiedenen Kurskonzepten herzustellen, was
vernetztes Denken fördert. Der \textbf{``Reflection Coach''}
(\textbf{mollick2024f?}) regt zur Reflexion über Erfahrungen an, um das
Gelernte zu konsolidieren. Der \textbf{``AI Tutor Blueprint''}
(\textbf{mollick2024f?}) ermöglicht es Lehrenden, eigene, auf ihre
...
ist und von Modell zu Modell variieren kann (\textbf{mollick2024f?}).
Die KI kann oberflächlich bleiben oder halluzinieren
(\textbf{mollick2024f?}).
...
Gemini (\textbf{jurran2025a?}). Vorreiter war der „Voice Mode`` von
OpenAI, den man als App auf dem Handy ausprobieren kann (gut in der
kostenfreien, sehr gut in der kostenpflichtigen Version), inzwischen
bietet Google/Gemini ähnliche Funktionen an. Die KI spricht auf Wunsch
über ein beliebiges Thema in einer beliebigen Sprache. Im
fortgeschrittenen Modus („\textbf{Advanced Voice Mode}``, für
Abonnenten) ist die Stimme noch realistischer und man kann unter anderem
die Geschwindigkeit und andere Stimmparameter anpassen. Im Standardmodus
kann man Dokumente hinzufügen, auf die sich die Unterhaltung beziehen
soll (s. das zweite Beispiel für Anwendungen). Damit lassen sich zum
Beispiel im Hochschulunterricht interaktive und unmittelbare Anwendungen
realisieren: Studierende könnten ihre Fragen in Seminar- oder
Vorlesungsphasen mündlich stellen, wobei die KI entsprechende Antworten
gibt, visuelle Inhalte erklärt oder sogar aktuelle Daten aus dem
Internet integriert. Besonders gut eignet es sich auch zum Lernen von
Sprachen: Man kann die englische Präsentation ausprobieren und sich
Feedback geben lassen. Solche Interaktionen kommen dem Ideal eines
persönlichen Tutors schon sehr nahe, ermöglicht eine enge, interaktive
und sehr auf die eigenen Bedürfnisse und Lernziele zugeschnittene
Zusammenarbeit und kann so Lernprozesse dynamischer gestalten.
...
an Hochschulen auswirken (\textbf{tutton2025b?}): Es werden eine breite
...
Universität} etwas ausführlicher darstellen (\textbf{kestin2024b?}). Der
Physik-Tutor ``PS2 Pal'' betreut Studierende in Physik-Einsteigerkursen
interaktiv und mit adaptiven Fragestellungen, was in der Evaluation zu
einem deutlich verbesserten Lernerfolg führte. Im Verbund mit kürzeren
Input-Phasen erhalten die Studierenden Aufgaben und Fragestellungen, die
sie direkt in Interaktion mit dem KI-Tutor bearbeiten können. Der Tutor
stellt Fragen, gibt bei Bedarf Hinweise und passt den Schwierigkeitsgrad
...
Physik-Tutor der Harvard Studie besprochen wird (\textbf{kestin2024b?}),
ist die \textbf{Bereitstellung von Musterlösungen als Input} (nicht nur
der Fragen), was die Gefahr von Ungenauigkeiten, Halluzinationen und
Inkonsistenzen in den Antworten des Sprachmodells deutlich reduziert.
Der Aufwand für die Erstaufsetzung steigt hier zwar, aber im Gegenzug
verspricht dieser Ansatz die Vorteile der individuellen Anleitung ohne
die Nachteile der Qualitätsunsicherheit. Insgesamt ist eine solche
Durchsicht und intensive Qualitätskontrolle klar zu empfehlen (dieser
Aspekt der intensiven Qualitätstests wird bei der Kurzvorstellung
einiger deutscher Fallstudien in Wannemacher et al. (2025)
vernachlässigt).
...
z.B. Analyse- oder Verhaltensmuster einzuüben. (\textbf{mollick2024f?})
...
realistischer machen: (\textbf{barra2024a?}) beschreiben den Einsatz von
...
VR-Brillen einzuüben (\textbf{heetkamp2023a?}).
...
ChatGPT für medizinische Simulationen. Quelle: (\textbf{barra2024a?})}

\end{figure}%

Eine umfangreiche Simulation beschreiben (\textbf{mollick2024d?}):
...
Feedback zu ermöglichen (\textbf{mollick2024d?}). Der Mehrwert liegt in
der skalierbaren Bereitstellung von Übungsmöglichkeiten für komplexe
Skills. Herausforderungen sind die Aufrechterhaltung der Konsistenz, die
Vermeidung von Bias und Halluzinationen sowie der hohe
Entwicklungsaufwand für solche Multi-Agenten-Systeme
(\textbf{mollick2024d?}).

\subsection{Goal Play -- zielgerichtete
Spiele}\label{goal-play-zielgerichtete-spiele}

In \textbf{zielgerichteten Spielen} (``Goal Play'',
(\textbf{mollick2024f?})) bleiben Studierende in ihrer normalen Rolle
und wenden in einer Situation bestimmtes Wissen oder theoretische
Konzepte an (z.B. Zielsetzung, Selbst-Distanzierung oder Analyseraster
wie Transaktionskostenanalyse), indem sie einen KI-Charakter anleiten.
...
(\textbf{mollick2024f?}) Studierende die Rolle des Lehrenden ein und
erklären der KI (die einen unwissenden Studenten spielt) ein Konzept.
Der Mehrwert liegt im vertieften Lernen durch Lehren (Protégé-Effekt)
und dem Aufdecken eigener Wissenslücken. Als Herausforderung kann die KI
manchmal vom Thema abweichen oder Fragen stellen, die die Studierenden
an ihre Grenzen bringen; zudem ist die Simulation eines ``Novizen''
durch die KI nur begrenzt realistisch (\textbf{mollick2024f?}).
...
entscheidend (\textbf{mollick2024f?}). Bei allen Simulatoren ist die
...
von Fragen die KI gut abschneidet und wo ihre Grenzen liegen
(\textbf{dellacqua2023a?}). Diese Erkenntnisse können dann genutzt
werden, um etwa Aufgabensets und andere Aufgabenstellungen besser zu
strukturieren.
...
(\textbf{lee2025a?}). Klassische „Hausaufgaben`` wie
...
von (\textbf{handa2025c?}) sehen, nutzen Studierende Sprachmodelle
gerade zur Schreibunterstützung intensiv und häufig. Das New York
Magazine betitelt eine aktuelle Recherche mit „\textbf{Everyone is
cheating their way through college}'', auf der Grundlage einer Vielzahl
von Interviews mit desillusionierten Studierenden und Lehrenden
(\textbf{walsh2025a?}). Der o.g. Artikel der Fachzeitschrift Nature (s.
Tabelle 4) skizziert ebenfalls basierend auf Interviews ein breites
Spektrum an aktiver Nutzung im höheren Bildungsbereich
(\textbf{heidt2025a?}).

Schon 2023 kündigte der Wharton Professor Mollick die „Homework
Apocalypse`` an (\textbf{mollick2023d?}). Dabei geht es Mollick weniger
um das Tricksen mit den neuen technischen Möglichkeiten („Cheating was
...
einzuordnen (\textbf{handa2025b?}): Hier werden vier Arten von
...
erwünschten Schwierigkeiten (desirable difficulties,
(\textbf{roediger2006b?})), das fragebasierte Durchkauen und Hin- und
Herüberlegen, das die Lernforschung als Wichtig für langfristiges
Behalten ansieht (\textbf{roediger2012b?}).
...
Prozessorientierung, Kontextualisierung sowie Kollaboration
(\textbf{gmeiner2025a?}).
...
Prüfungsformen ((\textbf{ward2024a?}))}
...
(\textbf{gmeiner2025a?}) und die Lernenden müssen ihre Entscheidungen in
der schriftlichen Arbeit erläutern und verteidigen. Die Studierenden
reichen ihre schriftliche Arbeit ein, die auch mit KI-Unterstützung
erstellt werden darf und führen ein dann ein etwa zehnminütiges Gespräch
über die Arbeit. Die Prüfenden wählen zum Beispiel zwei
Kernentscheidungen zur weiteren Erläuterung aus: Datenaufbereitung und
Argumentation. Die Studierenden erklären Vorgehen, Alternativen und
Grenzen. Es folgt ein kurzes Transfer-Szenario: „Was würden Sie ändern,
wenn\ldots?{}`` Bewertet werden Klarheit, Begründung, Umgang mit
Unsicherheit und Konsistenz zur Schriftfassung. KI-Regeln: KI-Nutzung
wird offengelegt; Antworten sind persönlich und ohne Hilfsmittel.
Skalierung gelingt mit standardisierten Leitfragen, Doppelprüfungen im
Stichprobenprinzip und Aufzeichnung für Zweitbewertungen. Dieses Format
eignet sich besonders für die Prüfung von Abschlussarbeiten und lässt
sich leicht auch auf Seminararbeiten übertragen. Ähnlich wie auch für
das folgende Format müssen hierfür initial Bewertungsmatrizen erstellt
werden, potentielle \textbf{Herausforderungen} sind situativer
\textbf{Stress} und Aspekte von \textbf{Validität} (Form vs.~Inhalt,
einfache vs.~schwere Fragen, mündliche vs.~schriftliche
Ausdrucksfähigkeit), \textbf{Reliabilität} (Rating-Unterschiede bei
verschiedenen Nachfragen und Bewertenden, verschiedenen Szenarien usw.)
und \textbf{Fairness} (z.B. Sprachfähigkeiten, Vorwissen). Vorteile sind
die Reaktivität und die Möglichkeit, durch vertiefende Nachfragen
Hintergrundwissen und Begründungen abzufragen (Akimov \& Malin, 2020,
S.31; \textbf{kearney2019a?}).
...
Prüfenden analysieren und bearbeiten müssen (\textbf{ward2024a?}).
...
können (\textbf{nibheolain2020a?})), Beispielaufnahmen zur Vorbereitung
...
Umgebungen wie Cadmus digitale Prozess-Spuren zu erfassen
(\textbf{mulder2023a?}). Eine Studie von Hanover Research fordert
gestaffelte Abgaben über die Zeit mit intensiver, iterativer Rückmeldung
und betont, dass die Sichtbarmachung individueller und kollaborativer
Arbeitsprozesse KI-Nutzung unattraktiv macht
(\textbf{hanoverresearch2024a?}). Empfehlungen der Monash University
konkretisieren dies: Prozessbewertungen, verbundene Aufgaben und
Einbindung der Prüfenden in den Entstehungsprozess (Monash University,
2025). Gmeiner operationalisiert Prozessfokus zudem durch transparente
KI-Nutzungsdokumentation mit Prompt-/Output-Belegen und reflektierter
Einbettung in die Eigenleistung (\textbf{gmeiner2025a?}).
...
Schwierigkeit, durch KI repliziert zu werden
((\textbf{hanoverresearch2024a?}))}
...
Berufsprodukte erzeugen (\textbf{mulder2023a?}). Monash rät,
Essayaufgaben so zu verändern, dass personalisierte Anwendung und
Kontextualisierung zwingend sind; außerdem werden multimodale Artefakte
als KI-resistenter eingestuft (Monash University, 2025). Gmeiner
präzisiert diese Logik: biografisches Lernen, Aufgaben an
außerschulischen Lernorten oder tagesaktuelle Kontexte machen die
Aufgabe „un-promptbar``, weil sie persönliche, physische oder
nicht-öffentliche Informationen, sinnliche Beobachtung und
Gegenwartsbezug erfordern (\textbf{gmeiner2025a?}).
...
KI-Missbrauch (\textbf{mulder2023a?}). Hanover Research betont ähnlich
...
plus Metareflexion (\textbf{hanoverresearch2024a?}).
...
bearbeitet und reflektiert werden (\textbf{gmeiner2025a?}). KI kann als
...
Eine Übersichtsstudie von (\textbf{an2025a?}) untersucht die
...
Hochschulforum Digitalisierung im Jahr 2024 (\textbf{tobor2024a?}), ein
Update im Februar 2025 ergänzt neuere Entwicklungen
(\textbf{tobor2025a?}). Die Analyse umfasst hochschulweiten Leitlinien
deutscher Universitäten zum Umgang mit generativer KI. Dabei hebt Tobor
eine Reihe bewährter Praktiken hervor, die sich in mehreren Leitfäden
wiederfinden (Für konkrete Beispiele siehe Appendix 2: Beispiele für
KI-Richtlinien):
...
(\textbf{an2025a?}) plädieren für ausgewogenere, zielgruppenspezifische
...
Die deutsche Untersuchung von (\textbf{tobor2025a?}) betont, dass die
Wirksamkeit solcher Leitlinien maßgeblich davon abhängt, ob sie
\textbf{bekannt gemacht, kontinuierlich diskutiert und weiterentwickelt}
werden. Zentral ist es, die Leitlinien User-adäquat zu gestalten und
bekannt zu machen. (Auch hier begegnen uns implizit wieder die zentralen
Kategorien Nutzerfreundlichkeit und wahrgenommene Nützlichkeit des
Technology Acceptance Models.) Tobor warnt davor, Leitlinien als bloße
...
\chapter{Didaktische Prompts -
Übersicht}\label{didaktische-prompts---uxfcbersicht}
...
Hilfskraft nicht zur Black Box wird (\textbf{mollick2024f?} betonen
...
(Lernende lehren die KI bzw. eine Novizin) (\textbf{mollick2024f?},
„Mentoring, Coaching, and Tutoring''; \textbf{mollick2023i?}). Ein
...
(\textbf{mollick2024f?}). Beispiele: Team-Charter als Startartefakt der
Kollaboration; Pre-Mortem mit Eintrittswahrscheinlichkeit/Schadenshöhe
und Ableitung von Gegenmaßnahmen; Devil's-Advocate-Prompt mit Fokus auf
Konsensfalle, versteckte Annahmen und Beleglage -- abschließend
visualisiert als Vergleichstabelle „Initial Decision vs.~Hidden
Assumptions''. Der Copilot ähnelt einer gut vorbereiteten Kollegin im
Projektmeeting, die methodisch führt, aber Ownership bei den Lernenden
belässt.
...
(\textbf{mollick2024f?}): simulationsbasiertes Üben, narrative
...
Lehrdesign, Leitfragen und Debriefing gerahmt bleibt
(\textbf{mollick2024f?}).
...
(\textbf{mollick2023i?}; \textbf{mollick2024f?}). Diese Einschränkungen
sind entscheidend für die Umwandlung eines allgemeinen Sprachmodells in
ein spezialisiertes pädagogisches Werkzeug. Durch die Einschränkung der
...
verschiebt (\textbf{yuen2025?}; \textbf{meehan2025?};
\textbf{newman2025?}).
...
Transferleistungen in realitätsnahen Bedingungen gefördert
(\textbf{welsh2025?}; \textbf{hobbick2025?}; \textbf{kentz2025?}).
...
Prompting-Strategien (\textbf{pedersen2025?}; \textbf{landfair2025?}).
...
Quellenarbeit und Reflexion (\textbf{ippolito2025?}).
...
Potenziale von GenAI genutzt werden (\textbf{taylor2025?}).

\chapter{Best Practice Sammlung didaktischer Prompts und
Aufgabenstellungen}\label{best-practice-sammlung-didaktischer-prompts-und-aufgabenstellungen}
...
\textbf{Funktion:} Datenkonvertierung; CSV-Formatierung;
Strukturklärung.
...
(Anthropic, n.d.a); GitHub-Version:
...
System Prompt Library (CSV Converter)}
(\textbf{saadCsvConverterPrompt?}).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: CSV Umwandler}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
(\textbf{anthropicDataOrganizer?}); Prompt-Typ auch in der Harvard
\textbf{System Prompt Library} (VPAL) dokumentiert (Wilson \& Tingley,
n.d.).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Daten-Organisierer}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
(Anthropic, n.d.b); GitHub-Variante in der
\href{https://github.com/ncwilson78/System-Prompt-Library}{System Prompt
Library} (Wilson \& Tingley, n.d.).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Excel Formel-Helfer}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: LaTeX generation}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
(\textbf{anthropicMeetingScribe?}); GitHub-Variante in der
\href{https://github.com/ncwilson78/System-Prompt-Library}{System Prompt
Library} (Wilson \& Tingley, n.d.).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Transkribieren: Meeting scribe}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Course content curator}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Interactive lecture assistant}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
(2025)} (\textbf{Azamy2025AIFlashDebates?}).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Flash debate starter --- Prompt 1 (Statements erzeugen)}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Flash debate starter --- Prompt 2 (Rollenspiel ableiten)}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
(2025)} (\textbf{newman2025?}).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Übung zum Korrigieren schlechter Aufsätze}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Student engagement enhancer}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
Mollick (n.d.)} (E. Mollick \& Mollick, n.d.).

\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hiwi: Structured prompt designer}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tutor: Allgemeiner Tutor}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tutor: Mentor-Bot}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, bottomrule=.15mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tutor: Reflexionshilfe}, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
Anthropic (2025, Dezember). Erste Schritte mit Agent Skills in der API.
\emph{Claude Docs}.
