...
Anfang 2026 hat sich „GenAI nutzen“ von der reinen Chatbot-Konversation hin zur **agentischen Arbeit** verschoben [@mollick2026]: Man delegiert Aufgaben, die KI nutzt Werkzeuge und arbeitet mehrstufig. Praktisch muss man dabei drei Ebenen auseinanderhalten: **Modelle** (das Sprachmodell, z.B. GPT 5.2), **Apps** (die Oberfläche, z.B. die Chat-Oberfläche von Chat GPT) und **Harnesses** (das „Arbeitsgeschirr“ oder Werkzeugkasten, etwa Web-Recherche, Zugriff auf einen Ordner mit Daten oder ein Tool das rechnen kann, wie Python). **Wichtig für die Lehre:** Viele Plattformen führen Nutzer*innen in kostenfreien Tarifen oder per „Auto“-Auswahl zu **schwächeren Modellvarianten** ohne oder mit nur sehr begrenztem Werkzeugkasten – das wirkt zunächst „gut genug“, erhöht aber das Risiko von Fehlern, veralteten Informationen und oberflächlichem Denken. Für die Lehre heißt das: Wer GenAI als Lehrassistenz delegiert nutzen will, sollte **bewusst eine starke Modellvariante** und ein passendes Harness wählen – und Ergebnisse grundsätzlich didaktisch gegenprüfen.
...
![GenAI als Kraftverstärker. Quelle: Gemini 2](images/ai-ebike-gemini.jpg){#fig-ai-ebike fig-align="center"}

## Was 2025 möglich ist: Praktische Beispiele für Recherche, Übungsaufgaben, Erklärungen {#sec-2025-examples}

**Schauen wir uns einige praktische Beispiele an**. Wir suchen aktuelle Fallstudien zu Lieferketten-Problemen. Als Recherche-Hiwi sucht das Sprachmodell auf akademischen Blogs und Fachzeitschriften nach aktuellen Beispielen.

![Recherche-Hiwi-Vorgehen. Quelle: Gemini 3 Pro](images/script01-dr-plan.svg){#fig-deep-research-plan fig-align="center"}

Solche Suchen führen Sprachmodelle mittlerweile in mehreren Schritten durch. Hier sehen wir den "Denkprozess".

![Recherche-Hiwi-Denkprozess. Quelle: Gemini 3 Pro](images/deep-research-recherche-aktuelle-lieferkettenprobleme-denkprozess-geminipro.svg){#fig-denkprozess fig-align="center"}
...
![Recherche-Hiwi-Ergebnis. Quelle: Gemini 3 Pro](images/deep-research-recherche-aktuelle-lieferkettenprobleme-ergebnis-auszug-geminipro.svg){#fig-ergebnis-bericht fig-align="center"}
...
![Recherche-Hiwi-Ergebnis - Quelle: NotebookLM](images/genai-integrierte-aufgaben-gen-notebooklm.svg){#fig-folien-notebooklm fig-align="center"}
...
![Recherche-Hiwi-Ergebnis. Quelle: Claude](images/lerntechniken-ppt-gen-claude-2025-12.svg){#fig-folien-claude fig-align="center"}
...
![Visualisierung und Erläuterung in einfacher Sprache von 6000+ Konferenzbeiträgen [@alammar2025a].](images/neurips-papers-visualization-eli5.jpg){#fig-conference-papers fig-align="center"}
...
**Auch komplexe Texte können die Sprachmodelle mittlerweile erstellen, prüfen und verbessern**. Wie weit sich das fortentwickelt hat, sehen wir am folgenden Beispiel: Einem vorgefertigten **'Skill'** - einer detaillierten Ablaufbeschreibung zur Erstellung komplexer Texte (@openai2025a; anthropic2025a; willison2025b).

::: {.callout-tip title="'I know Kung-Fu now' - modular Wissen hinzubuchen über 'Skills'"}
...
**Für Studierende sind GenAI Chatbots zum Standard für Informationssuche und Schreibaufgaben geworden**: So berichten 92 % der befragten britischen Vollzeitstudierenden (n=1.041, Erhebung im Dezember 2024), dass sie KI-Tools wie ChatGPT regelmäßig verwenden, und 88 % geben an, solche Tools für Prüfungsleistungen („for assessments“) zu nutzen [@freeman2025]. Deutsche Daten des CHE-Centrum für Hochschulentwicklung bestätigen dies: etwa zwei Drittel der Studierenden gaben Ende 2024 an, KI-Tools mindestens wöchentlich einzusetzen [@che2025ki] (65 %, n=23.288 von 171 Hochschulen).
...
![Gründe für die Verbreitung von GenAI nach dem Technologie-Akzeptanz-Modell. Quelle: Mit ChatGPT 5 im Mermaid Live Editor generiert - https://mermaid.live/edit](images/tam-diagram-mermaid.svg){#fig-tam fig-align="center"}
...
Im folgenden Kapitel werden wir zunächst einige Grundbegriffe (@sec-grundbegriffe) klären: Was sind große Sprachmodelle und was ist mit Begriffen wie Token, Prompt und RAG gemeint? Welche Modelle können Lehrende aktuell nutzen und welche Empfehlungen für Prompts sind belastbar? Dann fragen wir nach Zielen (@sec-didaktik): Welche Art von Wissen und Methoden unterscheidet und empfiehlt die Lernforschung? Welche didaktischen Wirkmechanismen können durch KI genutzt werden, um typische Probleme der Hochschullehre anzugehen? Im Abschnitt 4 schauen wir auf Praxisbeispiele (@sec-szenarien) für vier Anwendungsfelder von Sprachmodellen an Hochschulen: KI als Hiwi (direkte Arbeitserleichterung), KI als Copilot (Unterstützung beim Schreiben und Coden) und KI als Tutor (Feedback und Lernunterstützung) sowie KI als Simulator (Role Play und Goal Play). Abschließend zeigen wir verschiedene Anwendungen von KI in verschiedenen Kurstypen und gehen auf neue Herausforderungen für Prüfungen ein (@sec-umsetzung). Im Appendix finden Sie eine breite Sammlung von didaktischen Prompts und auf GenAI ausgerichteten Aufgabenstellungen von führenden Hochschulen. Dabei erläutern wir zunächst, wie die Prompts aufgebaut sind (@sec-prompts-ueberblick) und zeigen dann eine Liste strukturierter Best-Practice Beispiele (@sec-prompts).

## Schlaglichter aus der Forschung mit GenAI: Erfahrungsberichte aus den Disziplinen (GPT-5 und 5-Pro) {#sec-forschung-details}

Wie und wofür lassen sich die stärksten Sprachmodelle aktuell in der Forschung nutzen? Zum optionalen Abschluss dieses Kapitels finden Sie hier kurze Zusammenfassungen der Ergebnisse aus den verschiedenen Disziplinen [@bubeck2025].
...
**Link zurück zum Fließtext:** [Siehe @fig-ki-herausforderung]
